        ...
        <>
            <section className="about__container">
              ...
              <div className="about__images__container">
                <img className="about__image1" src="..\images\restaurantchef.jpg" alt="Restaurant Chef" />
                <img className="about__image2" src="..\images\MarioandAdrian A.jpg" alt="Restaurant Chefs" />
              </div>
            </section>
        </>
    )
